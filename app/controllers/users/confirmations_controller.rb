...
# Responsible for 'sign up' with 'confirmation_token'
class Users::ConfirmationsController < Devise::ConfirmationsController
  ...
  before_action :block_unauthenticated_user, only: %i[new create]
  ...
  private
    ...
    def cfm_params
      params.permit(
        :email, :password, :password_confirmation, :confirmation_token, :confirmed_at
      )
    end
