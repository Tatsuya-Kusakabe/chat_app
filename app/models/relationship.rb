class Relationship < ActiveRecord::Base
  ...
  private
    ...
    def relationship_unique
      pair_1 = Relationship.find_by(applicant_id: applicant_id, recipient_id: recipient_id)
      pair_2 = Relationship.find_by(applicant_id: recipient_id, recipient_id: applicant_id)
      valid = (pair_1.nil? && pair_2.nil?)
